...
namespace DemolishToPhase
{
    internal class App : IExternalApplication
    {
        public Result OnStartup(UIControlledApplication app)
        {
            ...
            clsButtonDataClass myButtonData = new clsButtonDataClass("btnDemolishToPhase", "My Button", cmdDemolishToPhase.GetMethod(), Properties.Resources.Blue_32, Properties.Resources.Blue_16, "This is a tooltip");
